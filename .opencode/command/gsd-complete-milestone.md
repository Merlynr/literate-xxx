...
- @F:/xxx/xxx/.opencode/get-shit-done/workflows/complete-milestone.md (main workflow)
- @F:/xxx/xxx/.opencode/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
