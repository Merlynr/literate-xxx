...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `F:/xxx/xxx/.opencode/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=F:/xxx/xxx/.opencode/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=F:/xxx/xxx/.opencode/commands/gsd
AGENTS_DIR=F:/xxx/xxx/.opencode/agents
```
...
<execution_context>
Surface state file: `F:/xxx/xxx/.opencode/skills/.gsd-surface.json`
Install profile marker: `F:/xxx/xxx/.opencode/skills/.gsd-profile`
Engine module: `F:/xxx/xxx/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `F:/xxx/xxx/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
