...
<!-- For checkpoint task examples and patterns, see @F:/xxx/xxx/.opencode/get-shit-done/references/checkpoints.md -->
...
See `F:/xxx/xxx/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `F:/xxx/xxx/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `F:/xxx/xxx/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
