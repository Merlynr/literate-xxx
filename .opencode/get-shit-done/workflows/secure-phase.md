...
```
Agent(
  prompt="Read F:/xxx/xxx/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/xxx/xxx/.opencode/get-shit-done/templates/SECURITY.md`
