...
```bash
INIT=$(node "F:/xxx/xxx/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @F:/xxx/xxx/.opencode/get-shit-done/templates/spec.md.
