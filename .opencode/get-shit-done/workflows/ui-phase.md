...
```markdown
Read F:/xxx/xxx/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: F:/xxx/xxx/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read F:/xxx/xxx/.opencode/agents/gsd-ui-checker.md for instructions.
